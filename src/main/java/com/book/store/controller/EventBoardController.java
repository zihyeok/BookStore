...
import com.book.store.util.FileManager_evt;
...
public class EventBoardController {
	...
	public ModelAndView created_ok(EventBoardDTO dto,@RequestParam(value = "upload",required = false) List<MultipartFile> upload,
			HttpServletRequest request) throws Exception{
		//값을 html에서 보내면 자동으로 EventBoardDTO에 장착
	...
	@GetMapping("/eventList.action") //html form에 POST>GET으로 바꿔야 검색 됨
	...
	public ModelAndView article(HttpServletRequest request) throws Exception{
	    //값을 html에서 보내면 자동으로 BoardDTO에 장착
	...
	@GetMapping("/eventDeleted_ok.action")
