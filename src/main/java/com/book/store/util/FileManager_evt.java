...
public class FileManager_evt {
//MultipartFile[]
	public static void doFileUpload(EventBoardDTO dto,
		...
		for (MultipartFile file : upload) {
			...
			if(!file.isEmpty()) {
				...
				dto.setImage("image" + "/" + newFileName);
				//img url링크 이걸로 set
				//역슬래쉬는 인식이 이상함
	...
	public static void doFileDelete(String image) {
